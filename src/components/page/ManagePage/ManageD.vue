                         ...
                         <li class="group-item-sub" v-for="n in v.perData">
                             <a href="">
                                  ...
                                  <div class="group-item-sub-text">
                                       ...
                                       <p class="p-text_h20"><span>科室：{{n.deptName}}</span><span>状态：{{n.useStatusname}}</span></p>
                                  </div>
                             </a>
                        </li>
                     </ul>
                     ...
                     <ul>
                         <li class="group-item-sub" v-for="n in v.devData">
                             <a href="">
                                  ...
                                  <div class="group-item-sub-text">
                                       <p class="p-text_h20"><span>名称：{{n.yqmc}}</span><span>编号：{{n.sbBh}}</span></p>
                                       <p class="p-text_h20"><span>位置：{{n.sbBuildingName}}</span>&nbsp;<span>层：{{n.sbBuildingLayer}}</span>&nbsp;<span>房间：{{n.sbRoomName}}</span></p>
                                        <p class="p-text_h20"><span>使用时间：{{n.sbAssignDate}}</span><span>类型：{{n.sbTypename}}</span></p>
                                  </div>
                             </a>
                        </li>
                     </ul>
